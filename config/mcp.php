...
return [
    ...
    */
    'server' => [
        'name' => env('MCP_SERVER_NAME', 'qBittorrent'),
    ...
    */
    'transports' => [
        ...
        'http_dedicated' => [
            ...
            'port' => (int) env('MCP_HTTP_DEDICATED_PORT', 34009),
    ...
    */
    'session' => [
        'driver' => env('MCP_SESSION_DRIVER', 'file'), // 'file', 'cache', 'database', 'redis', 'memcached', 'dynamodb', 'array'
